...
- **Passwörter & Auth:** Django-Passwort-Hashing (PBKDF2, `make_password`/`check_password`), signierte JWTs (kurzlebiger Access-Token + langlebiger Refresh-Token), CORS auf `CORS_ORIGINS` beschränkt.
