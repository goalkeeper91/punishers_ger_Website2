...
| Teams | `/admin/teams`, `/new`, `/:id/edit` | Team-CRUD, Teambild-Upload, Roster-Verwaltung, manuelle Match-Erfassung (siehe unten) | Anlegen/Löschen/alle Teams bearbeiten: Admin oder `teams.manage_teams`-Permission; Bearbeiten & Roster & Matches des **eigenen** Teams: zusätzlich Teammanager |
