  ...
  return (
    <div className="min-h-screen bg-gray-950 text-gray-100 font-sans">
      <main>
        ...
        <section className="relative py-20 md:py-32 bg-cover bg-center text-center" style={{ backgroundImage: `url('${backgroundUrl || bannerFallback("https://via.placeholder.com/1920x400?text=About+Us+Banner")}')` }}>
