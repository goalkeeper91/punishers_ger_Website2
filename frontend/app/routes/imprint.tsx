  ...
  return (
    <div className="min-h-screen bg-gray-950 text-gray-100 font-sans">
      <main>
        ...
        <section className="relative py-20 md:py-32 bg-cover bg-center text-center" style={{ backgroundImage: `url('${backgroundUrl || bannerFallback("https://via.placeholder.com/1920x400?text=Impressum+Banner")}')` }}>
          ...
          <div className="container mx-auto px-4">
            <div className="max-w-3xl mx-auto bg-gray-800 p-8 rounded-lg shadow-xl space-y-8">
              ...
              <div>
                ...
                <p className="text-gray-300">
                  {t("section4.body_prefix")} <a href="https://ec.europa.eu/consumers/odr" target="_blank" rel="noopener noreferrer" className="text-white hover:text-red-600 underline">https://ec.europa.eu/consumers/odr</a>.<br />
                  {t("section4.body_suffix")}
                </p>
