...
function LiveBadge({ creator }: { creator: Creator }) {
  ...
  return (
    <a
      ...
      className="mt-3 flex items-center gap-2 rounded-lg bg-red-600/10 border border-red-600 px-3 py-2 text-left hover:bg-red-600/20 transition-colors duration-300"
    >
      ...
      <main>
        ...
        <section className="relative py-20 md:py-32 bg-cover bg-center text-center" style={{ backgroundImage: "url('https://via.placeholder.com/1920x400?text=Creators+Banner')" }}>
          ...
          <div className="relative z-10 container mx-auto px-4">
            <h1 className="text-5xl md:text-6xl font-extrabold text-white mb-4">Unsere Content Creators</h1>
