...
export default function TeamsPage() {
  ...
  const games = ["Alle Spiele", "Counter-Strike 2", "Valorant", "League of Legends", "Rocket League", "Rainbow Six Siege"]; // Still hardcoded for filter buttons
      ...
      <main>
        ...
        <section className="relative py-20 md:py-32 bg-cover bg-center text-center" style={{ backgroundImage: "url('https://via.placeholder.com/1920x400?text=Teams+Banner')" }}>
          ...
          <div className="relative z-10 container mx-auto px-4">
            <h1 className="text-4xl sm:text-5xl md:text-6xl font-extrabold text-white mb-4 break-words">Unsere Esport Teams</h1>
            <p className="text-lg md:text-xl text-gray-300 max-w-3xl mx-auto">
              Hier findest du alle Informationen zu unseren talentierten Spielern und den Spielen, in denen wir antreten.
            </p>
          </div>
        </section>
        ...
        <section className="py-12 bg-gray-900">
          <div className="container mx-auto px-4 text-center">
            <h2 className="text-3xl font-bold text-white mb-6">Filter nach Spiel</h2>
        ...
        <section className="py-16 md:py-24 bg-gray-950">
          <div className="container mx-auto px-4 text-center">
            <h2 className="text-4xl font-bold text-white mb-6">Unsere Main Teams</h2>
            <p className="text-lg text-gray-400 mb-12 max-w-2xl mx-auto">
              Das sind die Aushängeschilder unserer Organisation, die auf höchstem Niveau um Siege kämpfen.
            </p>
        ...
        <section className="py-16 md:py-24 bg-gray-900">
          <div className="container mx-auto px-4 text-center">
            <h2 className="text-4xl font-bold text-white mb-6">Weitere Teams entdecken</h2>
            <p className="text-lg text-gray-400 mb-12 max-w-2xl mx-auto">
              Neben unseren Main Teams haben wir eine Vielzahl weiterer talentierter Squads in verschiedenen Spielen.
            </p>
