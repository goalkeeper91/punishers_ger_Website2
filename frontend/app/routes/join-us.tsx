...
export const meta: MetaFunction = () =>
  buildMeta({
    ...
    description: "Werde Spieler, Content Creator oder Community-Mitglied bei Punishers Germany. Finde deine Rolle in unserer Esport-Organisation!",
    path: "/join-us",
  });
  ...
  return (
    <div className="min-h-screen bg-gray-950 text-gray-100 font-sans">
      <main>
        ...
        <section className="relative py-20 md:py-32 bg-cover bg-center text-center" style={{ backgroundImage: `url('${backgroundUrl || bannerFallback("https://via.placeholder.com/1920x400?text=Join+Us+Banner")}')` }}>
          ...
          <div className="container mx-auto px-4 text-center">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              ...
              <div className="bg-gray-800 rounded-lg shadow-xl p-8 flex flex-col items-center transform hover:scale-105 transition-transform duration-300">
                <img src={imageFallback("https://via.placeholder.com/150?text=Player")} alt="Esport Player" className="w-32 h-32 rounded-full object-cover mb-6 border-4 border-red-600" />
              ...
              <div className="bg-gray-800 rounded-lg shadow-xl p-8 flex flex-col items-center transform hover:scale-105 transition-transform duration-300">
                <img src={imageFallback("https://via.placeholder.com/150?text=Creator")} alt="Content Creator" className="w-32 h-32 rounded-full object-cover mb-6 border-4 border-red-600" />
              ...
              <div className="bg-gray-800 rounded-lg shadow-xl p-8 flex flex-col items-center transform hover:scale-105 transition-transform duration-300">
                <img src={imageFallback("https://via.placeholder.com/150?text=Community")} alt="Community Member" className="w-32 h-32 rounded-full object-cover mb-6 border-4 border-red-600" />
